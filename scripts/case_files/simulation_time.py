    ...
    def run(self):
        ...
        for step in range(self.nt):
            ...
            if step == self.tpart_max:  
                self.init_poscell= self.particulator.attributes["position in cell"].data[0, -tot_seeds:]
            elif step == self.nt - 1:
                self.final_poscell= self.particulator.attributes["position in cell"].data[0, -tot_seeds:]
